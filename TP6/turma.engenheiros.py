...
def inserirAluno(lista, id, nome, notas):
    notaTPC = int(input("Qual foi a nota do TPC?"))
    notas.append(notaTPC)
    notaProj = int(input("Qual foi a nota do projeto?"))
    notas.append(notaProj)
    notaTeste = int(input("Qual foi a nota do teste?"))
...
while opcao != "0":
    ...
    if opcao == "1":
        ...
        nomef = input("Qual é o ficheiro que deseja carregar?")
        nomet = nomef
        turma1.clear()
