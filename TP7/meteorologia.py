...
tabMeteo1 = [((2022,1,20), 5, 8, 10),((2022,1,21), 1, 13, 0.2), ((2022,1,22), 7, 17, 0.01)]
...
def grafTabMeteo(t):
    ...
    plt.plot(datas, temps_max, label= "Temperatura Máxima", color = "pink", marker="o")
    plt.xlabel("Data")
...
while op != "0":
    ...
    if op == "1":
        ...
        fnome = input("Diga o nome do ficheiro que pretende usar:")
